...
class UsingMethodExam{
	...
	*/	
	public String methodExam03_02(String st, int num) {
		System.out.println("methodExam03_02가 호출되었습니다.");
		String stStupid = st+"바보";
		System.out.println(methodExam03_01(num));
		
		System.out.println(stStupid);
		return stStupid;
	}
     ...
     (구현부에서)하는 일 : 
		...
		methodExam03_02호출
	*/	
	void methodExam03_03(int num, String st) {
		System.out.println("methodExam03_03이 호출되었습니다.");
		methodExam03_02(st, num);
	}
	...
	*/	
	...
	protected double methodExam03_04(int num01, double num02, int num03) {
		System.out.println("methodExam03_04가 호출되었습니다.");
		MakeMethodExam02 mme = new MakeMethodExam02();
		
		return mme.methodExam02_04(num01, num02, num03);
	}
...
class UsingMethod{
	...
	public static void main(String[] args){
		...
		String st = ume.methodExam03_02("테스트",1);
		System.out.println("methodExam03_02 리턴값: " + st);
		
		ume.methodExam03_03(1,"테스트");
		
		double d = ume.methodExam03_04(7, 5.5, 8);

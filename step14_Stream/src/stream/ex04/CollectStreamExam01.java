...
public class CollectStreamExam01 {
	...
	public static void main(String[] args) {
		...
		totalList.add(new Student("장희정", "여", 92)); 
		totalList.add(new Student("하승현", "남", 87)); 
		...
		List<Student> list02 = totalList.stream()
				...
				.toList();
		// 추가
//		list02.add(new Student("미미", "남", 50)); // 추가안됨(불변) UnsupportedOperationException가 뜬다.
		...
		Map<String, Integer> map = totalList.stream().collect(Collectors.toMap(Student::getName, Student::getScore));
